...
function overrideInjections() {
    ...
    var Element_apis = ["innerHTML", "textContent"];
    ...
    var Element_text_apis = ["text"];   // We do care about setters...
    for (i = 0; i < Element_text_apis.length; ++i) {
        var api = Element_text_apis[i];
        var getter = HTMLScriptElement.prototype.__lookupGetter__(api);
        var prev = HTMLScriptElement.prototype.__lookupSetter__(api);     // Note, no [api] for some properties 
        (function(api, prev, getter) {
            HTMLScriptElement.prototype.__defineSetter__(api, function (val) {
            ...
            HTMLScriptElement.prototype.__defineGetter__(api, function () {
                // Here, we do not care...
                return getter.call(this);
            });
